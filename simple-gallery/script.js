...
// Open modal method
PrototypeGallery.prototype.openModal = function (selectedImage, list) {
	// Set main image
	this.setMainImage(selectedImage);

	this.modalImages.innerHTML = list
		.map((image) => {
			return `<img src="${image.src}" title="${image.title}" data-id="${image.dataset.id}" class="${
...
// Set main image method
PrototypeGallery.prototype.setMainImage = function (selectedImage) {
